...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxzaWQ2MDQiLCJhIjoiY2t6M3Q1NWp3MDl1czJub2YxejJ4ajFqaCJ9.tcDOUXKBB4HRABap_eejKA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/alsid604/ckz3tud81000b14uvokny9mdf',
    // style URL
    scrollZoom: false // center: [-118.115824, 34.11373], // starting position [lng, lat]
...
//type is either password "password" or "data"
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51KOtg9EOcCLFhIo7Kv4G887g2FQCboRTGAyHPKmMHQizV2yhQaZep46oDrUtuSmEnbYXP2yfZdMw3u9jqlKWKsB2006JyDEZwE');
            _context.prev = 1;
            _context.next = 4;
...
var logOutBtn = document.querySelector('.nav__el--logout'); //selecting by this class
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // const tourId = e.target.dataset.tourId; // bottom is the same just more clean..
